---
name: build-chrome
description: Package the Katsu new-tab extension as a Google Chrome / Chrome Web Store zip. Use when the user types /build-chrome or asks to build, zip, or package the Chrome plugin/extension.
